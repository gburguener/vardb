...
class TestVcfLoad(unittest.TestCase):
    ...
    def test_repeated(self):       
        data = StringIO(TestVcfLoad.VCF_HEADER +TestVcfLoad.missense +  TestVcfLoad.deletion) 
    ...
    def test_load(self):
        data = StringIO(TestVcfLoad.VCF_HEADER +TestVcfLoad.missense +  TestVcfLoad.not_annotated)
        self.db.load_variants(VcfSnpeffIO.parse(data), self.ref_organism, self.sample)
    ...
    def test_2_load(self):
        data = StringIO(TestVcfLoad.VCF_HEADER +TestVcfLoad.missense+  TestVcfLoad.not_annotated)
        self.db.load_variants(VcfSnpeffIO.parse(data), self.ref_organism, self.sample)
        data = StringIO(TestVcfLoad.VCF_HEADER +TestVcfLoad.missense2)
